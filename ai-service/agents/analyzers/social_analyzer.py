"""
SocialAnalyzerAgent - Analyzes social media posts from Twitter/X, LinkedIn, Reddit, etc.

Python equivalent of backend/src/agents/analyzers/SocialAnalyzerAgent.ts
"""
...
class SocialAnalyzerAgent(BaseAnalyzerAgent):
    """
    ...
    async def analyze(
        ...
        """Analyze social media content using specialized prompt."""
        system_prompt = self.get_system_prompt()
        user_prompt = self.build_user_prompt(context)
        return await self.invoke_with_trace(system_prompt, user_prompt, context)

    def get_system_prompt(self) -> str:
        """Get social media-specific system prompt."""
