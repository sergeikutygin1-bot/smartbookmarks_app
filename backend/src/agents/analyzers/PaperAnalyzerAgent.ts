 ...
 * Optimized for extracting methodology, findings, contributions, and citations.
 */
export class PaperAnalyzerAgent extends BaseAnalyzerAgent {
  constructor() {
    super({
...
- Preserve ALL numerical results, statistics, and technical precision
- Include specific p-values, effect sizes, confidence intervals when provided
- Tag with specific methods/algorithms (not just "machine-learning" but "transformers", "randomized-controlled-trial", etc.)
- Set confidence based on completeness: full paper = high, abstract only = medium`;
  }
}
